...
#if !(NETCOREAPP1_0 || NETCOREAPP1_1 || NETCOREAPP2_0 || NETCOREAPP2_1 || NETCOREAPP2_2)
            result = EncryptRijndael(plainText, passPhrase);
#else
            result = EncryptAES(plainText, passPhrase);
#endif
...
#if !(NETCOREAPP1_0 || NETCOREAPP1_1 || NETCOREAPP2_0 || NETCOREAPP2_1 || NETCOREAPP2_2)
            result = DecryptRijndael(cipherText, passPhrase);
#else
            result = DecryptAES(cipherText, passPhrase);
#endif
